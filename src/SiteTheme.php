    ...
    public function setSiteThemeConfig($site_id, $topic_id, $is_public, $path)
    {
        try {
            ...
            $data = array(
                ...
                'logo' => isset($site_info['logo']) ? 'https://img.holkee.com/site/store/logo/' . $site['name'] . '/' . $site_info['logo'] : '',
                ...
                'site_introdution_image' => isset($site_info['site_introdution_image']) ? 'https://img.holkee.com/site/store/' . $site['name'] . '/' . $site_info['site_introdution_image'] : '',
